...
fun HomeScreen(
    ...
    var recentPracticesExpanded by remember { mutableStateOf(false) }
        ...
        LazyColumn(
                ...
                Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween, verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        if (state.recentPractices.isNotEmpty()) {
                            TextButton(onClick = { recentPracticesExpanded = !recentPracticesExpanded }) {
                                Text(if (recentPracticesExpanded) "收起" else "展开")
                            }
                        }
            ...
            if (state.isLoading) {
                ...
                items(state.recentPractices, key = { it.key }) { practice ->
                    SessionSummaryCard(
                        practice = practice,
                        expanded = recentPracticesExpanded,
